...
class ReplyPostApiTest extends TestCase
{
    ...
    public function test_content_field_is_required_on_create_reply_post(){
        $users = User::factory()
            ->count(2)
            ->create();
        ...
        $response = $this->post('api/replypost',$mock_data);
        $response
            ->assertStatus(422)
            ->assertJson([
    ...
    public function test_should_not_reply_post_content_greater_than_777_characters(){
        $users = User::factory()
            ->count(2)
            ->create();
        $post = Post::factory()->create([
    ...
    public function test_post_id_field_is_required_on_create_reply_post()
    {
        $users = User::factory()
            ->count(2)
            ->create();
    ...
    public function test_post_id_field_should_be_valid_on_create_reply_post()
    {
        $users = User::factory()
            ->count(2)
            ->create();
    ...
    public function test_should_not_create_reply_post_when_have_more_than_five_posts_in_a_day(){
    ...
    public function test_should_create_reply_post(){
